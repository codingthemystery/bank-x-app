...
public class BankZController {
	...
	final KafkaTemplate<String, TransactionDto>kafkaTemplate;


	public BankZController(KafkaTemplate<String, TransactionDto> kafkaTemplate) {
	...
	public ResponseEntity<String> addTransactions(@RequestBody List<TransactionDto> transactions) {
		...
		return new ResponseEntity<String>("Submitted successfully.", HttpStatus.ACCEPTED);
	}
